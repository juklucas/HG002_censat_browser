...
awk 'BEGIN{OFS="\t"} {$5=100} 1' AS-SF-vs-HG002_asm_v1.0.bed > AS-SF-vs-HG002_asm_v1.0_forbb.bed
...
bedToBigBed \
    ...
    -type=bed9 \
    -tab \
    -as=HG002_censat_browser/track_builds/asat_sf/asat_sf.as \
    -sizesIs2Bit \
    AS-SF-vs-HG002_asm_v1.0_forbb.bed \
    hg002v1.0.fasta.2bit \
    AS-SF-vs-HG002_asm_v1.0.bb

conda deactivate


rm AS-SF-vs-HG002_asm_v1.0.bed
rm AS-SF-vs-HG002_asm_v1.0_forbb.bed
